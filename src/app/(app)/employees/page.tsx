...
export default function EmployeesPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: 'Tarief',
      hideOnMobile: true,
      render: (emp: Employee) => <span className="text-brand-400 font-medium">{formatCurrency(emp.hourlyRate)}/u</span>,
    },
    {
      key: 'active',
      header: 'Status',
        ...
        <Card className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-navy-800 border border-navy-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
            />
          </div>
        </Card>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {editingEmployee && (
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-300">Actief</span>
              </label>
            )}
